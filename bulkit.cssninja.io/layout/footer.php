        ...
        <div class="container">
            <div class="columns is-vcentered">
                <div class="column is-6">
                    <div class="mb-20">
                        <img class="small-footer-logo" src="assets/images/logos/bulkit-logo-deep-blue.png" alt="">
                    </div>
                    <div>
                        <span class="moto">Read with <i class="fa fa-heart color-red"></i></span>
                ...
                <div class="column">
                    <div class="footer-nav-right">
                        ...
                        <a class="footer-nav-link" href="#">Explore</a>
